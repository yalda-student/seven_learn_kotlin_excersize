...
class UserRepositoryTest {
    ...
    @Test
    fun `addUser should add a user successfully`() = runBlocking {
    ...
    @Test
    fun `addUser should not add a user with duplicate id`() = runBlocking {
    ...
    @Test
    fun `getAllUsers should return all added users`() = runBlocking {
        val user1 = User(1, "John Doe")
    ...
    @Test
    fun `deleteUser should remove the user`() = runBlocking {
        val user = User(1, "John Doe")
        userRepository.addUser(user)
